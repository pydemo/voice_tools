...
class AudioRecorder:
    def __init__(self):
        ...
        self.frames = []
        self.audio = None  # Will be initialized based on recording type
        self._callback = None
...
class AudioRecorderFrame(wx.Frame):
    ...
    def init_ui(self):
        ...
        h_both = wx.BoxSizer(wx.HORIZONTAL)
        h_both.Add(self.refresh_btn, 0, wx.ALL | wx.CENTER, 5)
        h_both.Add(self.both_btn, 0, wx.ALL | wx.CENTER, 5)
        main_sizer.Add(h_both, 0, wx.ALL | wx.CENTER, 5)
    ...
    def on_both(self, event):
        self.on_record(event, "mic")
        
        self.on_record(event, "speaker")
        self.speaker_record_btn.Disable()
        self.mic_record_btn.Disable()
    def on_stop_both(self, event):
        self.on_record(event, "mic")
