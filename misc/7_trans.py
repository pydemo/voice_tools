...
def capture_audio_and_transcribe(trackName, DURATION, CHUNK_SIZE=512):
    ...
    if 1:
        with pyaudio.PyAudio() as p:
            ...
            def callback(in_data, frame_count, time_info, status):
                ...
                try:
                    audio_data = sr.AudioData(in_data, int(default_speakers["defaultSampleRate"]), 2)
            ...
            with p.open(format=pyaudio.paInt16,
                ...
                print(f"The next {DURATION} seconds will be written to {filename} and transcribed.")
